          ...
          >
            ...
            <div className="glass-card" style={{ padding: '32px' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px', marginBottom: '20px' }}>
                ...
                <div>
                  <h3 style={{ fontSize: '1.15rem', fontWeight: 700, color: '#f8fafc', marginBottom: '4px' }}>{job.title}</h3>
                  <div style={{ color: '#a855f7', fontWeight: 600, fontSize: '0.9rem', marginBottom: '6px' }}>{job.company}</div>
              ...
              <ul style={{ display: 'flex', flexDirection: 'column', gap: '10px', listStyle: 'none', padding: 0 }}>
                {job.bullets.map((bullet, j) => (
                  <li key={j} style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', color: '#94a3b8', fontSize: '0.9rem', lineHeight: 1.6 }}>
